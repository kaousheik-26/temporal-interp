...
if __name__ == "__main__":
    ...
    # Results storage
    results = []
    questions = questions[:10]  # For testing, limit to first 10 questions
    ...
    for idx, q_data in enumerate(questions):
        ...
        with block_attention(model, KNOCKOUT_MODE, token_mapping, original_input_len, LAYERS_TO_KNOCKOUT):
    ...
    layer_suffix = f"_layers_{LAYERS_TO_KNOCKOUT[0]}_{LAYERS_TO_KNOCKOUT[-1]}" if LAYERS_TO_KNOCKOUT else "_all_layers"
    output_json = f"qwen2audio_mcqa_{KNOCKOUT_MODE}{layer_suffix}.json"
