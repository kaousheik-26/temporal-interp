...
def build_conversation(
    ...
    row: dict containing 'filename', 'question', 'A', 'B', 'C', 'D', 'correct_label'
    ...
    def collate_fn(examples: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]:
        ...
        if debug_first_batch and not first["done"]:
            ...
            if "audio_feature_lens" in batch_inputs:
                print(f"[DEBUG] audio_feature_lens shape: {tuple(batch_inputs['audio_feature_lens'].shape)}")
