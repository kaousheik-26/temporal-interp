...
OUTPUT_DIR = "/fs/gamma-projects/audio/kajayaku/temporal_understanding/models/qwen2audio/finetuned_model"
NUM_EPOCHS = 2
...
def main():
    ...
    train_dataset = preprocess_dataset(
        csv_path="/fs/gamma-projects/audio/kajayaku/temporal_understanding/curated_data/audio_grounding_final/audio_grounding_train_clean_rephrased.csv",
        system_prompt=args.system_prompt,
        audio_base_path="/fs/gamma-projects/audio/apoorvak/tacos_dataset/audios_folder",
    )
    val_dataset = preprocess_dataset(
        csv_path="/fs/gamma-projects/audio/kajayaku/temporal_understanding/curated_data/audio_grounding_final/audio_grounding_val_clean_rephrased.csv",
        system_prompt=args.system_prompt,
        audio_base_path="/fs/gamma-projects/audio/apoorvak/tacos_dataset/audios_folder",
    )
