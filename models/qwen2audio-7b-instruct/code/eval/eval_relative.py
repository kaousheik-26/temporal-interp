...
def build_prompt_text(example, system_prompt: str | None = None):
    """Build prompt text for multiple choice question."""
...
def save_predictions(predictions: List[Dict], output_file: str):
    """Save predictions to JSON file and print accuracy."""
...
def main():
    ...
    for pred in predictions[:5]:
        ...
        print(f"Ground truth: {pred['ground_truth']} | Prediction: {pred['prediction']} | {'✓' if pred['correct'] else '✗'}")
